...
public abstract class AbstractImageOp implements BufferedImageOp {
    ...
    int getPixel(int[] pixels, int x, int y, int width, int height, int edgeMode) {
    ...
    private int bilinear(int nw, int ne, int sw, int se, double xd, double yd) {
        return linear(linear(nw, ne, xd), linear(sw, se, xd), yd);
    }

    int getPixelBilinear(int[] pixels, double x, double y, int width, int height, int edgeMode) {
